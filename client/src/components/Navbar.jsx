  ...
  return (
    <div className="flex px-[2vw] py-[2vw] justify-between items-center border border-gray-300">
      ...
      <div className="flex justify-around w-[30%]">
        ...
        {/* Show SignIn link only if currentUser is null */}
        {!currentUser && (
        ...
        >
          <img 
            className="absolute inline-block top-[0px] h-[30px] w-[30px]" 
            style={{ borderRadius: "50%" }} 
            src={currentUser ? currentUser.avatar : ""} 
            alt="" 
          />
          <h3 className="absolute top-[5%] left-[30%] inline-block">
            {currentUser ? currentUser.companyname : "Your Name"}
          </h3>
          ...
          {/* Show dropdown and logout button if dropdown is selected and currentUser exists */}
          {dropdownselected && currentUser && (
            <div
